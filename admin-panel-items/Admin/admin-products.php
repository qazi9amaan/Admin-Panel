...
$db->where('product_belongs_to','owner');
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Products Uploaded By Admin</h1>
        </div>
        <div class="col-lg-6">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo substr(htmlspecialchars($row['product_desc']),0,50); ?>...</td>
    ...
    <div class="text-center">
    	<?php echo paginationLinks($page, $total_pages, 'admin-products.php'); ?>
    </div>
    <!-- //Pagination -->
</div>
<script>
