...
$db = getDbInstance();
$select = array('p.id', 'p.product_name', 'p.product_desc', 'p.product_status_reason','p.product_owner' ,'p.product_category', 'p.file_name','p.product_price', 'p.product_status', 'p.product_quality','p.created_at', 'p.updated_at','u.bussiness_name');
...
$db->where('product_status', 'Rechecking');
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-10">
            <h1 class="page-header">Rejected Products</h1>
        </div>
        <div class="col-lg-1 ">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['product_status_reason']); ?></td>
