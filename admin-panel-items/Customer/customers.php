...
$rows = $db->arraybuilder()->paginate('user_profiles', $page);
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row['init_address'].' '.$row['init_address'].' '.$row['town'] ?></td>
                <td><?php echo htmlspecialchars($row['pincode']); ?></td>
                <td><?php echo htmlspecialchars($row['state']); ?></td>
                <td>
                    <a href="/admin/admin-panel-items/Customer/view_customer.php?customer_id=<?php echo $row['id']; ?>&operation=view" class="btn btn-success delete_btn" ><i class="glyphicon glyphicon-eye-open"></i></a>
                    ...
                    <form action="delete_customer.php" method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="del_id" id="del_id" value="<?php echo $row['user']; ?>">
